...
class FhirOperator(fhirContext: FhirContext, fhirEngine: FhirEngine) {
  ...
  private val fhirEngineLibraryContentProvider = FhirEngineLibraryContentProvider(adapterFactory)
    ...
    LibrarySourceProviderFactory(
      ...
      hashSetOf<TypedLibrarySourceProviderFactory>(
        object : TypedLibrarySourceProviderFactory {
          ...
          override fun create(url: String?, headers: MutableList<String>?) = fhirEngineLibraryContentProvider
        }
      ),
  ...
  private val evaluatorBuilderSupplier = Supplier {
    CqlEvaluatorBuilder()
      .withLibrarySourceProvider(fhirEngineLibraryContentProvider)
  ...
  fun loadLib(lib: Library) {
    ...
    if (lib.name != null) {
      fhirEngineLibraryContentProvider.libs[lib.name] = lib
    }
  }
