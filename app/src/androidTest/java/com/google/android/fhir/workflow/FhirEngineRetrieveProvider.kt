...
class FhirEngineRetrieveProvider(private val fhirEngine: FhirEngine) :
  ...
  override fun retrieve(
    ...
    return runBlocking {
      if (contextPath == "id" && contextValue is String) {
        listOf(fhirEngine.load(getClazz(dataType!!), contextValue))
      } else {
  ...
  private fun getClazz(dataType: String): Class<Resource> {
    return Class.forName("org.hl7.fhir.r4.model.$dataType") as Class<Resource>
  }
